...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_CAPS, _______, _______, KC_UP,   _______, _______, _______, _______, _______, _______, _______, _______, _______, RESET,            _______,
        _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_BSPC, KC_LCTL, KC_HOME, KC_END,  _______,          _______,          _______,
